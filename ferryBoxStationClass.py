...
class FerryBoxStation:
    ...
    def __init__(self,stationid,metadata,df_st):
    ...
    def bin_dataframe(self):
        ...
        binned = self.df_st_grouped.groupby([x_bins,y_bins])['chla_fluorescence'].mean().reset_index()
    ...
    def interpolate_irregular_data_to_grid(self):
        ...
        interpolator = tri.LinearTriInterpolator(triang, binned.chla_fluorescence)
    ...
    def create_station_contour_plot(self): 
        ...
        cbar.set_label('Klorofyll a fluorescens (\u03bcg/L)', rotation=90)
